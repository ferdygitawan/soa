...
<head>
  ...
  <title>CV. AGNI SENTRAL MOTOR - Admin</title>
  <link rel="icon" href="<?php echo site_url('uploads/products/img/favicon.ico'); ?>" type="image/gif">
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html"><b>ASM-Agni Sentral Motor</b></a>
      </div>
      <!-- Top Menu Items -->
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          ...
          <?php if ($this->ion_auth->is_admin() || $this->ion_auth->is_sale()): ?>
            <li><a href="<?php echo site_url('admin/sale') ?>"><i class="fa fa-fw fa-pencil-square-o"></i> Sales Order</a></li>
          <?php endif ?>
		  
		  <?php if ($this->ion_auth->is_admin() || $this->ion_auth->is_sale()): ?>
            <li><a href="<?php echo site_url('admin/sale1') ?>"><i class="fa fa-fw fa-dollar"></i> Payment SO</a></li>
          <?php endif ?>
          ...
          <?php if ($this->ion_auth->is_admin()): ?>
            ...
            <li><a href="<?php echo site_url('admin/customer') ?>"><i class="fa fa-fw fa-user-secret"></i> Customer</a></li>
            <li><a href="<?php echo site_url('admin/auth') ?>"><i class="fa fa-fw fa-users"></i> User</a></li>
          <?php endif ?>
        </ul>
      </div>
      <!-- /.navbar-collapse -->
